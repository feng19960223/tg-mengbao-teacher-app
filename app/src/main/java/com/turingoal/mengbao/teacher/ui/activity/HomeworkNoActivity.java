...
import com.turingoal.mengbao.teacher.ui.adapter.HomeworkNoAdapter;
 ...
 * 没有完成作业人员
 */
@Route(path = ConstantActivityPath.HOMEWORK_NO)
public class HomeworkNoActivity extends TgBaseActivity {
    ...
    private HomeworkNoAdapter mAdapter = new HomeworkNoAdapter();

    @Override
    protected int getLayoutID() {
        return R.layout.activity_homework_no;
    }

    @Override
    protected void initialized() {
        tvTitle.setText(R.string.activity_homework_no);
    ...
    private void getData() {
        PostRequest request = TgHttpUtil.requestPost(ConstantUrls.URL_HOMEWORK_RECORD_NO, getHttpTaskKey());
